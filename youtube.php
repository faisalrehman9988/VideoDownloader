<?php
// youtube.php - YouTube single-page downloader
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header class="sticky top-0 z-40 border-b border-neutral-200/70 bg-white/70 backdrop-blur-md">
    <div class="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav class="hidden sm:flex items-center gap-6 text-sm">
                ...
                <a href="youtube.php" class="text-neutral-900 font-semibold transition-colors">YouTube</a>
...
<main class="flex-1">
    <section class="max-w-2xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        <span class="inline-flex items-center gap-2 rounded-full bg-red-600 text-white text-xs font-semibold px-3 py-1 mb-5">
            <svg viewBox="0 0 24 24" fill="white" class="w-6 h-6"><path d="M21.6 7.2s-.2-1.5-.8-2.1c-.8-.8-1.7-.8-2.1-.9C15.9 4 12 4 12 4h0s-3.9 0-6.7.2c-.4 0-1.3.1-2.1.9-.6.6-.8 2.1-.8 2.1S2.2 9 2.2 10.7v1.6c0 1.8.2 3.5.2 3.5s.2 1.5.8 2.1c.8.8 1.8.8 2.3.9 1.7.1 7 .2 7 .2s3.9 0 6.7-.3c.4 0 1.3-.1 2.1-.9.6-.6.8-2.1.8-2.1s.2-1.8.2-3.5v-1.6c0-1.8-.2-3.5-.2-3.5zM9.9 14.6V8.9l5.4 2.9-5.4 2.8z"/></svg> YouTube
        </span>
        <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight mb-3">YouTube Video Downloader</h1>
        <p class="text-neutral-500 mb-8">Paste a YouTube link below to preview and download the video.</p>
