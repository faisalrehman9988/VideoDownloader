<?php
// instagram.php - Instagram single-page downloader
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header class="sticky top-0 z-40 border-b border-neutral-200/70 bg-white/70 backdrop-blur-md">
    <div class="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="index.php" class="flex items-center gap-2.5">
            ...
            <span class="font-extrabold text-lg tracking-tight">clip<span class="text-emerald-500">grab</span></span>
        </a>
        <nav class="hidden sm:flex items-center gap-6 text-sm">
                ...
                <a href="instagram.php" class="text-neutral-900 font-semibold transition-colors">Instagram</a>
